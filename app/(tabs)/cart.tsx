...
export default function Cart() {
  const { cartItems, cartTotal, addToCart, removeFromCart, clearCart, updateQuantity, itemCount, isLoading } = useCart();
      ...
      {cartItems.length > 0 ? (
        < >
          ...
          <View className='p-4 bg-white shadow-sm rounded-t-3xl'>
            ...
            {/* Check out button */}
            <TouchableOpacity className='items-center justify-center py-3 rounded-full bg-primary'
